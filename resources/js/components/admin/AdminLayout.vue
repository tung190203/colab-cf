...
const navItems = computed(() => {
    const items = [
        ...
        { label: 'Nhập đơn thủ công', icon: ShoppingCart, to: '/staff/manual-orders', roles: ['admin', 'staff', 'shift_leader'] },
        ...
        { label: 'Theo dõi chấm công', icon: ClipboardCheck, to: '/admin/attendance', roles: ['admin', 'shift_leader'] },
        { label: 'Audit log chấm công', icon: FileClock, to: '/admin/audit-logs', roles: ['admin'] },
        { label: 'Thưởng / Phạt', icon: Ban, to: '/admin/penalty-rules', roles: ['admin'] },
